...
// ==========================================
if (fs.existsSync('parcheggi_attestamento.geojson')) {
    const rawData = JSON.parse(fs.readFileSync('parcheggi_attestamento.geojson', 'utf8')) as GeoJSON.FeatureCollection<GeoJSON.Polygon | GeoJSON.MultiPolygon, AttestamentoProperties>;
...
// ==========================================
if (fs.existsSync('zone_parcheggio.geojson')) {
    const rawData = JSON.parse(fs.readFileSync('zone_parcheggio.geojson', 'utf8')) as GeoJSON.FeatureCollection<GeoJSON.Polygon | GeoJSON.MultiPolygon, ZoneParcheggioProperties>;
...
// ==========================================
if (fs.existsSync('parcheggio_protetto_bike.geojson')) {
    const rawData = JSON.parse(fs.readFileSync('parcheggio_protetto_bike.geojson', 'utf8')) as GeoJSON.FeatureCollection<GeoJSON.Point, ProtettoBikeProperties>;
...
fs.writeFileSync('trentino_parkings.osm', finalXmlContent, 'utf8');
